function [map1,act_x,act_y,act_t,quivers_X,quivers_Y,quivers_vx,quivers_vy,CVmap,v,vout,quivers_Xout,quivers_Yout, quivers_vxout,quivers_vyout,onedev,vari,SE,repolmap,repolact_t,repolact_x,repolact_y]...
...
XYT=[x',y',t'];
if velmaxin > 1
[quivers_X,quivers_Y,T,quivers_vx,quivers_vy,v,fitxyt]=master_vel(XYT,MINt,MAXt,velminin,velmaxin,winsize,wint);
else
    [quivers_X,quivers_Y,T,quivers_vx,quivers_vy,v,fitxyt]=master_vel(XYT,MINt,MAXt,0,100,winsize,wint);
end
factor = pix*1000;
v=v.*factor;
%% outlier removal
