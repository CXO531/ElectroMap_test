...
% Last Modified by GUIDE v2.5 16-Dec-2018 18:10:44
...
handles.averages=[];
[handles.preimages,images,averages,mask] = OMimprocess(handles.fname,handles.im,handles.rect,handles.num_images,handles.cropchoice,handles.mask,sfilt,sfiltsize,inversion,tfilt,handles.frameremove,handles.camopt,str2double(get(handles.sfiltsigma,'String')));
